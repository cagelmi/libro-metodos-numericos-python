# Libro "Metodos Numericos Aplicados a la Ingeniería: Casos de estudio utilizando PYTHON" (2024)
...
Este repositorio es una traducción de MATLAB a Python de los 12 casos de estudios del texto. Para conocer los enunciados, por favor, consulten el libro.
